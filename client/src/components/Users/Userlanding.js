          ...
          {/* <Carousel.Item className="mt-5 user-landing-background">
            <div className="row">
              <div className="col mt-5">
                <p className="user-landing-para text-left">
                  Explore a dynamic exchange platform
                </p>
                <div className="text-center">
                  <button type="button" className="user-landing-button">
                    Explore Now
                  </button>
                </div>
              </div>
              <div className="col" style={{position: "relative"}}>
                <img
                  src={carouselitem1}
                  className="userlanding-carouselitem12"
                ></img>
              </div>
            </div>
          </Carousel.Item> */}
          {/* <Carousel.Item className="mt-5 user-landing-background">
            <div className="row mt-3">
              <div className="col-8 mt-3">
                <h1 className="ms-5 mt-5 user-landing-h1 container">
                  Tradehub
                </h1>
                ...
                <div className="text-center mt-5">
                  <button type="button" className="user-landing-button2 mt-5">
                    Shop Now
                  </button>
                </div>
              </div>
              <div className="col-4">
                <img
                  src={carouselitem2}
                  className="userlanding-carouselitem2 "
                ></img>
              </div>
            </div>
          </Carousel.Item> */}
            ...
            <div className="row">
              <div className="col-8 mt-2">
                <div className="ms-5 mt-2">
                  <h1 className="mt-5 user-landing-h1">Exchange Exchange</h1>
                </div>
                <div className="user-landing-div mt-5 ms-5">
                  <span>
                  Explore a dynamic exchange platform<br></br>
            ...
            <div className="col-6 container">
              ...
              <div className="container">
                <p className="user-landing-paragraph mt-5">
                  Trade Hub is the industry-standard message solution for
                  reliable, cost-effective and post-trade communications,
                  transmitting settlement notification, reconciliation
                  information, and other trade details between investment
                  managers and custodian banks.a place where goods from other
        ...
        <div className="row container">
          ...
          <div className="col container mt-5">
            <Card style={{ width: "18rem" }}>
              <Card.Body className="userlanding-text">
                <Card.Text>
                  <b>Seamless Exchanges</b>
                  <p className="mb-4 mt-3">
                    With TradeHub’s commitment to transparency and fairness,
