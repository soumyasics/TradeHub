    ...
    <div>
      <div className="useredit-profile-nav fixed-top">
        <div className="useredit-profile-navicon ms-5">
          <Link to="/user/user-profile" className="useredit-profile-color-link">
            <FaArrowLeft />
          </Link>
          ...
          <img
            src={
              profileImage
                ...
                : `${BASE_URL}/${data.profile.filename}`
            }
            alt="Profile"
            className="useredit-profile-img"
          />
          ...
          <div className="col-4 container ">
            <form onSubmit={handleSubmit}>
              ...
              <input
                ...
                onChange={handleChange}
              />
              <label className="useredit-profile-label mt-3">
                Phone number
              </label>
              <input
                type="text"
