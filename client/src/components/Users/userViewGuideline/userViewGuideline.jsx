   ...
   <div>
    <UserChatNavbar/>
     <div style={{ minHeight: "100vh" }} className="userViewGuideline-body">
      <h1 className="userViewGuideline-heading">{state?.title || "Our terms and conditions"}</h1>
      {/* <h3>Content</h3> */}
      <p>
